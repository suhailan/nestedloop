	...
	public static void main(String[] args) {
		...
		for (int rakaat = 1; rakaat <= 4; rakaat++){
			...
			for (int sujud=1;sujud <=2; sujud++){   
				...
				if (sujud==1) {
					rukun("Duduk Antara Dua Sujud", "Fi'li");
					sunat("Bacaan Duduk Antara Dua Sujud", "Hai'ah", "Rabbighfirli warhamni wajburni warfa'kni warzuqni wahdini wa'afini wa'kfu 'anni");
				}
			}
			if (rakaat==2)
